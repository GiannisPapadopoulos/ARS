...
for i = 1:numExperiments
    [x0, y0, score] = runGradientDescent(rosenbrock, rosenfx, rosenfy, 0.000001, 0);
    % [x0, y0, score] = runGradientDescent(rastrigin, rastriginfx, rastriginfy, 0.001, 0);
    scores(i) = score;
end;
...
% Can be run for better visualization of the results
